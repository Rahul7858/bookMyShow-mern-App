...
export default function LastBookingDetails(props) {
  const { finishLoading, lastBookingPresent, seat, timing, movieName, errorMsg } = props;
  ...
  return (
    <div className="LastBooking" style={{ border: "1px solid black" }}>
