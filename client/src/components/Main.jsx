...
import LastBookingDetails from "./LastBookingDetails.jsx";
...
export default function Main() {
  ...
  const seatSelectHandler = (e) => {
    // Parse the new seat value to ensure it's a valid number
    const newValue = parseInt(e.target.value, 10);

    // Prevent negative values
    if (newValue < 0) {
      // You can show an error message or handle the negative value in your UI as needed.
      // For this example, I'm just setting the value to 0.
      newValue = 0;
    }
  ...
  return (
    <Container>
      <SnackbarProvider />
      <Loader show={lastBooking.isLoading} />
